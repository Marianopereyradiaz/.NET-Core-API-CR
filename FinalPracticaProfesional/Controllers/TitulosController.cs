...
namespace FinalPracticaProfesional.Controllers
{
    ...
    public class TitulosController : ControllerBase
    {
        ...
        public TitulosController(FinalPracticaProfesionalContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Titulo>> PostTitulo(Titulo titulo)
        {
            ...
            return CreatedAtAction("GetTitulo", new { id = titulo.Id_Titulo }, titulo);
        }
        ...
        {
            return _context.Titulos.Any(e => e.Id_Titulo == id);
        }
    }
}
